        ...
        <div className="bento-music-main">
          ...
          <div className="bento-eq-panel">
            <div className="bento-wave-wrap" aria-hidden="true">
              ...
              <svg
                className="bento-wave-svg bento-wave-svg--1"
                viewBox="0 0 800 180"
              ...
              >
                ...
                <path
                  className="bento-wave-path bento-wave-path--1"
                  filter="url(#bwf1)"
              ...
              <svg
                className="bento-wave-svg bento-wave-svg--2"
                viewBox="0 0 800 180"
                preserveAspectRatio="none"
              >
                <defs>
                ...
                <path
                  className="bento-wave-path bento-wave-path--2"
                  filter="url(#bwf2)"
              ...
              <svg
                className="bento-wave-svg bento-wave-svg--3"
                viewBox="0 0 800 180"
                preserveAspectRatio="none"
              >
                <defs>
                ...
                <path
                  className="bento-wave-path bento-wave-path--3"
                  filter="url(#bwf3)"
              ...
              <svg
                className="bento-wave-svg bento-wave-svg--4"
                viewBox="0 0 800 180"
                preserveAspectRatio="none"
              >
                <defs>
                ...
                <path
                  className="bento-wave-path bento-wave-path--4"
                  filter="url(#bwf4)"
