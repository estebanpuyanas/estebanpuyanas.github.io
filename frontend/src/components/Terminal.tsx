...
function processCommand(
  ...
  if (lower === 'help') {
    ...
    for (const [cmd, desc] of commands) {
      lines.push({ id: id(), type: 'output', content: `${cmd.padEnd(20)} ${desc}` })
    }
  ...
  if (lower === 'whoami') {
    return [
      ...
      { id: id(), type: 'output', content: 'B.S. Computer Science & Philosophy' },
      { id: id(), type: 'output', content: 'Northeastern University — Boston, MA' },
      { id: id(), type: 'blank', content: '' },
    ]
  }
  ...
  if (lower === 'about') {
    return [
      { id: id(), type: 'blank', content: '' },
      { id: id(), type: 'output', content: 'Aspiring software engineer with a passion for systems,' },
      { id: id(), type: 'output', content: 'data engineering, and embedded software. Elegant solutions' },
      { id: id(), type: 'output', content: 'from firmware to distributed pipelines.' },
      { id: id(), type: 'output', content: 'Outside code: squash, chess, and music writing.' },
      { id: id(), type: 'blank', content: '' },
    ]
  }
  ...
  if (lower === 'github') {
    window.open('https://github.com/estebanpuyanas', '_blank', 'noopener,noreferrer')
    return [
      { id: id(), type: 'blank', content: '' },
      { id: id(), type: 'output', content: 'Opening github.com/estebanpuyanas ...' },
      { id: id(), type: 'blank', content: '' },
    ]
  }

  if (lower === 'linkedin') {
    window.open('https://linkedin.com/in/estebanpuyanas', '_blank', 'noopener,noreferrer')
    return [
      { id: id(), type: 'blank', content: '' },
      { id: id(), type: 'output', content: 'Opening linkedin.com/in/estebanpuyanas ...' },
      { id: id(), type: 'blank', content: '' },
    ]
  }
  ...
  if (lower.startsWith('open ')) {
    ...
    return [
      { id: id(), type: 'blank', content: '' },
      { id: id(), type: 'error', content: `open: no page '${target}' — try: ${SECTIONS.join(', ')}` },
      { id: id(), type: 'blank', content: '' },
    ]
  }
...
export default function Terminal() {
  ...
  const handleSubmit = useCallback(() => {
    ...
    const echoLine: OutputLine = { id: nextId(), type: 'input', content: input }
