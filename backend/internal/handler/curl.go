...
func buildIndexPage(host string) string {
	...
	//   inner (visual content width) = 80
	//   outer (with │ borders)       = 82
	//   top:    ┌─ about  (9) + ─×72 + ┐ = 82
	//   bottom: └ + ─×80 + ┘           = 82
	const aboutInner = 80
	...
	// ── About box ─────────────────────────────────────────────────────────────
	// top: ┌─ (2) + space (1) + about (5) + space (1) + ─×57 (57) + ┐ (1) = 67 (outer)
	...
	aboutLine("")
	aboutLine("  Software engineer with a passion for building elegant, high-impact software.")
	aboutLine("  Interested in distributed systems, backend development, and data engineering.")
	aboutLine("  Outside of work: gym, squash, running, and music.")
	aboutLine("")
	...
	// ── Links box ─────────────────────────────────────────────────────────────
	// top: ┌─ (2) + space (1) + links (5) + space (1) + ─×14 (14) + ┬ (1) + ─×36 (36) + ┐ (1) = 61 (outer)
